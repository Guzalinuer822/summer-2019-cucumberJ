Feature: Account types
  ...
  Scenario Outline: Login with different users
    ...
    Examples:
      ...
      | store manager | Marketing  | Compaigns       | All - Campaigns - Marketing  |
